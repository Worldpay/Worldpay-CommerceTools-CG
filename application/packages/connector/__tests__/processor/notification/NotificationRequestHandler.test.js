...
const NotificationRequestHandler = require('../../../src/processor/notification/NotificationRequestHandler')
...
jest.mock('../../../src/worldpay/WorldpayNotification')
...
describe('NotificationRequestHandler', () => {
  ...
  describe('getStoragePromise', () => {
    it('should return the response from `handleStorage` when the `handleStorage` option is defined', async () => {
      ...
      expect(processor.handleStorage.execute).toHaveBeenCalledWith({ test: 1 }, '<xml>payload</xml>')
  ...
  describe('validateNotification', () => {
    it('should not throw if the notification object is valid', () => {
      ...
      expect(() => processor.validateNotification({ merchantCode: 'testMerchantCode' })).not.toThrow()
    })
    ...
    it('should throw if the notification object is not valid', () => {
      ...
      expect(() => processor.validateNotification({ merchantCode: 'testMerchantCodeInvalid' })).toThrow()
    })
  })
})
