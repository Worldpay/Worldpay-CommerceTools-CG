...
describe('ShopperAccountRiskData', () => {
  ...
  test('should throw error when date is not a date', () => {
    const riskData = new WorldpayShopperAccountRiskData().withShopperAccountCreationDate('not_a_date')
  ...
  test('should be invalid with invalid value for PurchasesCompletedLastSixMonths', () => {
    let riskData = new WorldpayShopperAccountRiskData().withPurchasesCompletedLastSixMonths('invalid')
    expect(riskData.isValid()).toBe(false)
  ...
  test('should be invalid with invalid value for ShippingNameMatchesAccountName', () => {
    let riskData = new WorldpayShopperAccountRiskData().withShippingNameMatchesAccountName('invalid')
    expect(riskData.isValid()).toBe(false)
  ...
  test('should be invalid with invalid value for ShopperAccountPasswordChangeIndicator', () => {
    let riskData = new WorldpayShopperAccountRiskData().withShopperAccountPasswordChangeIndicator('invalid')
    expect(riskData.isValid()).toBe(false)
  ...
  test('should be invalid with invalid value for ShopperAccountPaymentAccountIndicator', () => {
    let riskData = new WorldpayShopperAccountRiskData().withShopperAccountPaymentAccountIndicator('invalid')
    expect(riskData.isValid()).toBe(false)
  ...
  test('should be invalid with invalid value for ShopperAccountShippingAddressUsageIndicator', () => {
    let riskData = new WorldpayShopperAccountRiskData().withShopperAccountShippingAddressUsageIndicator('invalid')
    expect(riskData.isValid()).toBe(false)
    riskData = new WorldpayShopperAccountRiskData().withShopperAccountShippingAddressUsageIndicator(10)
    expect(riskData.isValid()).toBe(false)
  })
})
