...
describe('WorldpayFraudSightData', () => {
  ...
  test('should not be set the birth date correctly', () => {
    ...
    expect(data.birthDate).toBeDefined()
    expect(data.address).toBeUndefined()
    expect(data.validate()).toEqual(['BirthDate must be of type date'])
  ...
  test('should validate the the custom item arrays are not larger than the allowed maximum', () => {
    ...
    expect(data1.validate()).toEqual(['CustomNumericFields can have a maximum of 10 items'])

    const data2 = new WorldpayFraudSightData()
    data2.withCustomStringFields(new Array(11).fill('test'))
    expect(data2.validate()).toEqual(['CustomStringFields can have a maximum of 10 items'])
    ...
    expect(data3.validate()).toEqual([
      'CustomStringFields can have a maximum of 10 items',
      'CustomNumericFields can have a maximum of 10 items',
    ])
  })
  ...
  test('should validate the the custom item arrays are not larger than the allowed maximum', () => {
    ...
    expect(data.validate()).toEqual(['CustomNumericFields can have a maximum of 10 items'])
  })
  ...
  test('should output the expected XML when all items are set', () => {
    ...
    const data = new WorldpayFraudSightData()
      ...
      .withCustomStringFields(['one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten'])
