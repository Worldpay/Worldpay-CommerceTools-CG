...
} = require('../../src/utils/macCodeValidator')
...
describe('MAC Code Generation', () => {
  ...
  test('should generate invalid code with modified adminCode', () => {
    const stringToHash = ['MYADMINCODE^MYMERCHANT^T0211010_MODIFIED', '1400', 'GBP', 'AUTHORISED'].join(':')
...
describe('MAC Code Verification', () => {
  ...
  test('should fail with altered payment currency', () => {
    expect(verifyMacCode(TEST_REDIRECT_URL_ALTERED_PAYMENT_CURRENCY, TEST_MAC_SECRET)).toEqual(false)
  })
