...
/**
 * Builder to create the Klarna Pay Later payment
 */
class WorldpayKlarnaPayLaterPaymentDetails extends WorldpayPaymentDetails {
...
module.exports = WorldpayKlarnaPayLaterPaymentDetails
