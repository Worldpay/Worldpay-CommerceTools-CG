  ...
  buildXmlData() {
    ...
    const data = {
      shopperAccountRiskData: {
        ...
        shopperAccountPasswordChangeDate: this.asWorldpayDate(
          this.shopperAccountPasswordChangeDate
        ),
        shopperAccountShippingAddressFirstUseDate: this.asWorldpayDate(
          this.shopperAccountShippingAddressFirstUseDate
        ),
        shopperAccountPaymentAccountFirstUseDate: this.asWorldpayDate(
          this.shopperAccountPaymentAccountFirstUseDate
        ),
